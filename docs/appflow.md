...
| `/music` | `pages/MusicPage.jsx` | The music app. Wide: left rail, search, mood chips, card rows. Phone: app bar, bottom nav, full-screen now-playing. Both keep a bar that stays put and a Song/Video switch |
